...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role3 = Role::create(['name' => 'Profesor']); // Creamos role para Profesor
        $role4 = Role::create(['name' => 'Tutor']); // Creamos role para padre o tutor
        ...
        Permission::create(['name' => 'users.edit'])->syncRoles([$role1, $role3]);
        Permission::create(['name' => 'users.show'])->syncRoles([$role1, $role3, $role4]);
        Permission::create(['name' => 'users.update'])->syncRoles([$role1]);
        Permission::create(['name' => 'users.destroy'])->syncRoles([$role1, $role3]);
        ...
        Permission::create(['name' => 'posts.show'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'posts.update'])->syncRoles([$role1, $role2, $role3]);
        Permission::create(['name' => 'posts.delete'])->syncRoles([$role1, $role2, $role3]);
